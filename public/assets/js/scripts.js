...
if(window.Chart) {
  ...
  Chart.defaults.plugins.tooltip.bodyFontColor = "rgba(255,255,255,.7)";
  Chart.defaults.plugins.tooltip.titleMarginBottom = 10;
  Chart.defaults.plugins.tooltip.titleFontSize = 14;
  Chart.defaults.plugins.tooltip.titleFontFamily = "'Nunito', 'Segoe UI', 'Arial'";
  Chart.defaults.plugins.tooltip.titleFontColor = '#fff';
